...
Eight findings, in the order they would bite. The first three are silent
...
music at resting volume, then beeps at 45, then music, then beeps. Options:
duck the room's music for the whole ring (my recommendation), or stop it
outright at ring start, or leave it and see. Cheap to test once F1–F3 are in.
